...
db_user = ""		# <-- set database user here
db_password = ""	# <-- set database password here

api_user = ""		# <-- set chronontology user here
api_password = ""	# <-- set chronontology password here

db = DBI.connect("DBI:Mysql:arachne:arachne.uni-koeln.de", db_user, db_password)
db.execute("SET NAMES 'utf8'")

api = RestClient::Resource.new("localhost:8080", :user => api_user, :password => api_password)
